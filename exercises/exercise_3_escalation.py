    ...
    with console.status("[dim]LLM reviewing the diff...[/dim]"):
        analysis = llm.invoke([
            {"role": "system", "content": (
                ...
                "2–4 specific, context-rich questions that reference the relevant "
                "file or section in the diff."
            )},
        ...
        refined = llm.invoke([
            {
                "role": "system",
                "content": (
                    "Senior reviewer. Refine the original review using the human "
                    "reviewer's answers. Keep comments specific, update confidence "
                    "to reflect the added context, and return structured output."
                ),
            },
            {
                "role": "user",
